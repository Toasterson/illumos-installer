...
pub fn get_supported_keywords() -> Vec<(String, KeywordDefinition)> {
    vec![
        ...
        ("system_locale".into(), KeywordDefinition{ options: vec![] }),
        ("network_interface".into(), KeywordDefinition{ options: vec![
            "name".into(),
            "static".into(),
            "static6".into(),
            "primary".into(),
        ] }),
        ("dataset".into(), KeywordDefinition{ options: vec![
            "aclinherit".into(),
            "aclmode".into(),
            "atime".into(),
            "canmount".into(),
        ...
        ("setup_dns".into(), KeywordDefinition{ options: vec![
            "search".into(),
            "domain".into(),
        ] }),
        ("route".into(), KeywordDefinition{ options: vec![] }),
        ("root_password".into(), KeywordDefinition{ options: vec![] }),
    ]
}